...
#define VTSEQ(ID) ("\x1b[" #ID "m")
    ...
    static Text vtextprintf(const char* format, va_list vlist)
    {
        ...
        auto buff = static_cast<char*>(malloc(bytes_needed + 1));
    ...
    {
        static constexpr char buff[] =
            ".   .   .   .   .   .   .   .   .   .   " ".   .   .   .   .   .   .   .   .   .   "
            ".   .   .   .   .   .   .   .   .   .   " ".   .   .   .   .   .   .   .   .   .   "
            ".   .   .   .   .   .   .   .   .   .   " ".   .   .   .   .   .   .   .   .   .   "
            ".   .   .   .   .   .   .   .   .   .   " ".   .   .   .   .   .   .   .   .   .   "
            ".   .   .   .   .   .   .   .   .   .   " ".   .   .   .   .   .   .   .   .   .   ";
        static constexpr size_t INDENTATION_WIDTH = 4;
        static constexpr size_t NUM_INDENTATIONS  = (sizeof(buff) - 1) / INDENTATION_WIDTH;
    ...
    {
        DCHECK_LT_F(num, 16u);
        if (num < 10u) { out.push_back(static_cast<char>('0' + num)); }
        else { out.push_back(static_cast<char>('A' + num - 10)); }
    }
...
#define getcwd _getcwd
    ...
    void write_date_time(char* buff, unsigned long long buff_size)
    {
        ...
        time_t    sec_since_epoch = static_cast<time_t>(ms_since_epoch / 1000);
        tm        time_info;
    ...
    */
...
#elif LOGURU_WINTHREADS
        snprintf(buffer, length, "%s", thread_name_buffer());
#else
    ...
    static void print_preamble(char*    out_buff, size_t out_buff_size, Verbosity verbosity, const char* file,
                               unsigned line)
    {
        if (out_buff_size == 0) { return; }
        out_buff[0] = '\0';
...
#define LOGURU_THREAD_LOCAL thread_local
    ...
    Text ec_to_text(char c)
    {
        ...
        {
            if (num < 10u) { str += static_cast<char>('0' + num); }
            else { str += static_cast<char>('a' + num - 10); }
        };
...
#undef DEFINE_EC
    ...
    Text ec_to_text(EcHandle ec_handle)
    {
        ...
        auto   with_newline = reinterpret_cast<char*>(malloc(buffer_size));
        with_newline[0]     = '\n';
#ifdef _WIN32
